...
<div class="head-menu">
	...
	<ul class="menu">
		...
		<li><a href="#">Форум</a>
				...
				<li><a href="./edit_forum.php">Управление</a></li>
				<li><a href="./forum_text.php">Текст приветствия</a></li>
			</ul>  
		</li>
		<li><a href="">Информация</a>
			<ul>
				<li><a href="./stat_today.php">Статистика за сегодня</a></li>
				<li><a href="./stat_mounth.php">Статистика за месяц</a></li>
				<li><a href="./stat_year.php">Статистика за Год</a></li>
			</ul>
		</li>
	</ul>
